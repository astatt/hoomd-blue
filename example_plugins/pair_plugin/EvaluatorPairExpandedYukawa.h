...
class EvaluatorPairExpandedYukawa
    ...
    struct param_type
        ...
        Scalar kappa; //!< Screening parameter
        Scalar delta; //!< Delta value to subtract from distances
    ...
    */
    DEVICE bool evalForceAndEnergy(Scalar& force_divr, Scalar& pair_eng, bool energy_shift)
        ...
        if (rsq < rcutsq)
            ...
            force_divr = epsilon*exponent*(kappa_delt + 1)*rinv_delt*rinv_delt*rinv;
    ...
    static std::string getName()
        {
        return std::string("expanded_yukawa_pair");
        }
    ...
    Scalar delta; //!< Stored delta value from the constructor
    };
